...
@plateforme_bp.route("", methods=["POST"], strict_slashes=False)
@jwt_required()
...
@plateforme_bp.route("/<int:plateforme_id>", methods=["PUT"])
@jwt_required()
